...
export default function LoginForm() {
  ...
  return (
    <div className="w-full h-full overflow-hidden bg-white p-4 sm:p-6 shadow-lg rounded-lg" role="main" aria-label="Login page">
      <div className="mx-auto w-full max-w-md">
        <h1 className="text-center text-lg font-extrabold text-gray-900">Sign in to your account</h1>
        ...
        <form className="space-y-4" onSubmit={handleSubmit} noValidate>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-1.5 block text-xs text-gray-900">
                Remember me
              </label>
            </div>
